...
<div id="topContent" class="row" ng-controller="main">
    <div class="large-12 medium-12 columns">
        ...
        <form id="crmForm" name="newPromotionForm" action="test.php" method="POST" onsubmit="return checkForm(this);">
            ...
            <div class="row">
                <div class="large-3 medium-3 columns">
                    <select name="seg1" ng-model="seg1">
            ...
            <div class="row">
                ...
                <div class="large-2 medium-2 columns large-offset-1 medium-offset-1">
                    ...
                    <div class="switch round">
                        <input name="AB_Group" id="abTest" type="checkbox" ng-model="abTest">
                        <label for="abTest">
                            <span class="switch-on">ON</span>
                            <span class="switch-off">OFF</span>
                        </label>
            ...
            <div class="row abTestDuplicateContent">
                <div class="large-6 medium-6 columns" ng-show="abTest">
                    <hr class="hr-text hr-big-text" data-content="A" ng-show="abTest">
                ...
                <div class="large-6 medium-6 columns" ng-show="abTest">
                    <hr class="hr-text hr-big-text" data-content="B" ng-show="abTest">
                    <div class="row abTestSliders">
                        <div class="large-2 small-2 columns">
            ...
            <div class="row collapse abTestDuplicateContent">
                ...
                <div class="large-6 medium-6 columns bTest" ng-show="abTest">
                    <div class="large-3 medium-3 columns">
                        <label>Test Accounts</label>
                        <div class="switch round">
            ...
            <div class="row collapse abTestDuplicateContent">
                ...
                <div class="large-6 medium-6 columns">
                    ...
                    <div class="row" ng-if="obj.segDeposit">
                        <div class="large-6 medium-6 columns end">
                            <div class="paramsTable">
                                <table>
                                    ...
                                    <tr ng-if="seg2 == 'All' || seg2 == 'OTD'">
                                        <td>OTD Active</td>
                                        <td><input name="SegmentedDep_OTD_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_OTD_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesA">
                                        <td>Norm Active</td>
                                        <td><input name="SegmentedDep_Norm_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_Norm_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesA">
                                        <td>HV Active</td>
                                        <td><input name="SegmentedDep_HV_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_HV_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesA vipPlayerValuesA">
                                        <td>Sapphire Active</td>
                                        <td><input name="SegmentedDep_Sapphire_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_Sapphire_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesA vipPlayerValuesA">
                                        <td>Ruby Active</td>
                                        <td><input name="SegmentedDep_Ruby_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_Ruby_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesA vipPlayerValuesA">
                                        <td>Diamond Active</td>
                                        <td><input name="SegmentedDep_Diamond_Promocode" type="text"/></td>
                                        <td><input name="SegmentedDep_Diamond_BonusPer" type="number"/></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="large-6 medium-6 columns bTest" ng-show="abTest">
                    ...
                    <div class="row" ng-if="obj.segDepositB">
                        <div class="large-6 medium-6 columns end">
                            <div class="paramsTable">
                                <table>
                                    <tr>
                                    ...
                                    <tr ng-if="seg2 == 'All' || seg2 == 'OTD'">
                                        <td>OTD Active</td>
                                        <td><input name="b--SegmentedDep_OTD_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_OTD_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesB">
                                        <td>Norm Active</td>
                                        <td><input name="b--SegmentedDep_Norm_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_Norm_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr>
                                        <td>HV Active</td>
                                        <td><input name="b--SegmentedDep_HV_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_HV_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesB vipPlayerValuesB">
                                        <td>Sapphire Active</td>
                                        <td><input name="b--SegmentedDep_Sapphire_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_Sapphire_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesB vipPlayerValuesB">
                                        <td>Ruby Active</td>
                                        <td><input name="b--SegmentedDep_Ruby_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_Ruby_BonusPer" type="number"/></td>
                                    </tr>
                                    <tr class="allPlayerValuesB vipPlayerValuesB">
                                        <td>Diamond Active</td>
                                        <td><input name="b--SegmentedDep_Diamond_Promocode" type="text"/></td>
                                        <td><input name="b--SegmentedDep_Diamond_BonusPer" type="number"/></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <!-- SMS Table B -->
                    <div class="row" >
                        <div class="large-12 medium-12 columns" ng-if="smsB">
                            <hr class="hr-text" data-content="SMS">
                            <div class="row">
                                <div class="large-6 medium-6 columns">
                                    <label>Send SMS</label>
                    ...
                    <!-- OMG Table B -->
                    <div class="row">
                        <div class="large-12 medium-12 columns" ng-if="omgB">
                            <hr class="hr-text" data-content="OMG">
                            <div class="row">
                                <div class="large-6 medium-6 columns">
                                    <label>OMG End Date</label>
